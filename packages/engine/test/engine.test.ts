...
describe('Engine', () => {
  it('determinism: same seed yields same outcome', () => {
    function runSim() {
      ...
      const input: TurnInput = { actions: { EAT_HEALTHY: 0, WORK_OUT: 0, HAVE_FUN: 0, BUILD_BUSINESS: 0, WORK: 3, STUDY_WORK: 1, REST: 1, SIDE_GIG: 0, STUDY_LIFE: 0, JOB_HUNT: 0 } };
  ...
  it('lose-condition', () => {
    ...
    const input: TurnInput = { actions: { EAT_HEALTHY: 0, WORK_OUT: 0, HAVE_FUN: 0, BUILD_BUSINESS: 0, WORK: 0, STUDY_WORK: 0, REST: 5, SIDE_GIG: 0, STUDY_LIFE: 0, JOB_HUNT: 0 } };
  ...
  it('promotion test', () => {
    ...
    const input: TurnInput = { actions: { EAT_HEALTHY: 0, WORK_OUT: 0, HAVE_FUN: 0, BUILD_BUSINESS: 0, WORK: 0, STUDY_WORK: 2, REST: 2, SIDE_GIG: 0, STUDY_LIFE: 0, JOB_HUNT: 1 } };
    ...
    // Now work 1 pt
    const res2 = resolveTurn(state, { actions: { EAT_HEALTHY: 0, WORK_OUT: 0, HAVE_FUN: 0, BUILD_BUSINESS: 0, WORK: 1, STUDY_WORK: 0, REST: 4, SIDE_GIG: 0, STUDY_LIFE: 0, JOB_HUNT: 0 } });
  ...
  it('wellbeing-helps: bonus energy from good health', () => {
    ...
    s.health = 90;
    s.stress = 20;
    const inp = { actions: { WORK: 3, REST: 2, EAT_HEALTHY: 1, WORK_OUT: 0, HAVE_FUN: 0, BUILD_BUSINESS: 0, STUDY_WORK: 0, STUDY_LIFE: 0, JOB_HUNT: 0, SIDE_GIG: 0 }};
  ...
  it('income-factor: high stress reduces income, low health lowers medical risk threshold', () => {
    ...
    s.stress = 90;
    s.cash = 0;
    resolveTurn(s, { actions: { WORK: 1, REST: 0, EAT_HEALTHY: 0, WORK_OUT: 0, HAVE_FUN: 0, BUILD_BUSINESS: 0, STUDY_WORK: 0, STUDY_LIFE: 0, JOB_HUNT: 0, SIDE_GIG: 0 }});
  ...
  it('ledger-integrity-with-WELLBEING', () => {
    ...
    resolveTurn(s, { actions: { EAT_HEALTHY: 1, WORK: 0, REST: 0, WORK_OUT: 0, HAVE_FUN: 0, BUILD_BUSINESS: 0, STUDY_WORK: 0, STUDY_LIFE: 0, JOB_HUNT: 0, SIDE_GIG: 0 }});
